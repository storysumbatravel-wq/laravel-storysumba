...
<body class="font-body bg-luxury-100 min-h-screen flex items-center justify-center">
    ...
    <div class="relative w-full max-w-md mx-4">
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <!-- TAMBAHKAN autocomplete="off" PADA FORM -->
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <!-- TAMBAHKAN autocomplete="off" PADA INPUT -->
                                <input type="email"
                                       id="email"
                                       name="email"
                                       value="{{ old('email') }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password"
                                       ...
                                       required
                                       autocomplete="off"
                                       class="w-full pl-12 pr-12 py-3 bg-luxury-50 border border-luxury-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all placeholder-luxury-400"
                                       placeholder="">

                                <!-- Tombol Toggle Password (Kanan) -->
                                <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-luxury-400 hover:text-luxury-600 focus:outline-none">
                                    <!-- Icon Mata (Terbuka) - Default -->
                                    <svg id="eyeIcon" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                    </svg>
                                    <!-- Icon Mata (Tertutup) - Hidden awalnya -->
    ...
    <!-- Script untuk Toggle Password & Safety Clear -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 2. Fungsi Safety: Kosongkan value input saat halaman dimuat
            // Ini memastikan setelah logout, kolom benar-benar kosong meski browser mencoba mengisi otomatis
