        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <!-- Stat 2: File Icon -->
                    <div class="text-center p-4 bg-white rounded-xl shadow-luxury">
                        <!-- Mengganti 100+ dengan Ikon File -->
                        <svg class="w-10 h-10 mx-auto text-red-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    ...
                    <!-- Stat 4: Seal Icon -->
                    <div class="text-center p-4 bg-white rounded-xl shadow-luxury">
                        <!-- Mengganti 25+ dengan Ikon Seal/Check Badge -->
                        <svg class="w-10 h-10 mx-auto text-red-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
